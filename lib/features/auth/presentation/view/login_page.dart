...
// import 'package:thrift_store/features/dashboard/presentation/view/dashboard_view.dart'; // <-- import your dashboard screen
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<LoginViewModel, LoginState>(
        listener: (context, state) {
          if (state.isSuccess) {
            // FIX: Navigate using the named route '/dashboard'
